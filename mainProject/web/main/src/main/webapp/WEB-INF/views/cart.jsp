                    ...
                    <tbody id="cartItems">
                        <c:forEach var="item" items="${cartItems}">
                            <tr>
                                ...
                                <td>₩<span class="price" data-price="${item.price}"><fmt:formatNumber value="${item.price}" /></span></td>
                                <td>
                                    <input type="number" class="form-control quantity" value="${item.quantity}" min="1" max="10" style="width: 80px;" data-price="${item.price}" data-id="${item.productId}">
                                </td>
                                <td><span class="total"><fmt:formatNumber value="${item.price * item.quantity}" /></span></td>
                                <td>
            ...
            <div class="col-md-8">
                <div class="card p-3">
                    ...
                    <div class="d-flex justify-content-between">
                        <span>상품 합계</span> 
                        <span id="totalPrice">₩<fmt:formatNumber value="${totalPrice}" /></span>
                    </div>
                    ...
                    <hr>
                    <div class="d-flex justify-content-between">
                        <strong>총 합계</strong> <strong id="grandTotal">₩<fmt:formatNumber value="${totalPrice + 3000}" /></strong>
                    </div>
                    <div class="text-center mt-4">
                        <button class="btn btn-success w-100">결제하기</button>
                    </div>
                </div>
            </div>
        </div>
